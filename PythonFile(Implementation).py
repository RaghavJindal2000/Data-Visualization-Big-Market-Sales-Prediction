...
Original file is located at
    https://colab.research.google.com/drive/1G4qvUb8jNiNR76PiydYdPhQpYR7JSRrS
"""

import pandas as pd 
#import numpy as np

train=pd.read_csv("C:/train_v9rqX0R.csv", na_values={"Item_Visibility":[0]})
...
def modelfit(alg, dtrain, dtest, predictors, target, IDcol, filename):
    ...
    cv_score = sklearn.model_selection.cross_val_score(alg, dtrain[predictors], dtrain[target], cv=20, scoring='neg_mean_squared_error') 
